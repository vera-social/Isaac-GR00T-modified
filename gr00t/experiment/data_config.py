...
class xArm6DataConfig(BaseDataConfig):
    video_keys = ["video.left_image", "video.right_image", "video.wrist_image"]
    # state_keys = ["state.arm", "state.gripper", "state.joint_velocity", "state.cartesian_position", "state.quaternion", "state.alternate_angle"]
    # action_keys = ["action.arm", "action.gripper", "action.joint_velocity", "action.cartesian_position", "action.quaternion", "action.alternate_angle"]
    state_keys = ["state.arm", "state.gripper"]
    action_keys = ["action.arm", "action.gripper"]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))
